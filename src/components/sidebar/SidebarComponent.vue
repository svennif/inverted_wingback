...
<template>
    <button @click="toggleSidebar" type="button" class="inline-flex items-center py-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700">
    ...
    <header  :class="{ 'translate-x-0': isSidebarOpen, '-translate-x-full': !isSidebarOpen }" id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                ...
                <div class="font-medium mb-2 m-auto items-center px-5 dark:text-white">Inverted Wingback</div>
